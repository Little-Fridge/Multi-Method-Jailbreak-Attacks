...
def main():
    p = argparse.ArgumentParser(description="PAIR攻击：LLaVA-7B -> Baichuan2-7B-Chat")
    p.add_argument("-i","--input",required=True)
    p.add_argument("-o","--output",required=True)
    p.add_argument("--atk_model",default="/share/project/test/backup/arc/ppx/llava-1.5-7b-hf")
    p.add_argument("--tgt_model",default="/share/project/test/backup/arc/ppx/Baichuan2-7B-Chat")
    ...
    print("加载目标模型(Baichuan2-Chat):", args.tgt_model)
